...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void insertEntry(String refno,String product_id,String product_name, int price,int count,String ordersum,String username)
    {
    ...
    public Cursor getOrderNumbers(String username)
    {
